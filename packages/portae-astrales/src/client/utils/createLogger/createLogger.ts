...
export default function createLogger(level: TLogLevel): ILogger {
  ...
  return {
    debug: (message?: any, ...optionalParams: any[]) => canLog('debug') && console.log(message, ...optionalParams),
    error: (message?: any, ...optionalParams: any[]) => canLog('error') && console.error(message, ...optionalParams),
    info: (message?: any, ...optionalParams: any[]) => canLog('info') && console.info(message, ...optionalParams),
    warn: (message?: any, ...optionalParams: any[]) => canLog('warn') && console.warn(message, ...optionalParams),
  };
}
